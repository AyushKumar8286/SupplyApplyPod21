...
# 8
s.source_files = "SupplyApply/Data/**/*.{swift}", "SupplyApply/Constants/**/*.{swift}", "SupplyApply/Helpers/**/*.{swift}", "SupplyApply/Model/**/*.{swift}", "SupplyApply/Routing/**/*.{swift}", "SupplyApply/Screens/**/*.{swift,xib}", "SupplyApply/Fonts/**/*.{swift}"
